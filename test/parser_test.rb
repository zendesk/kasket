  ...
  context "Parsing" do
    ...
    context "key generation" do
      should "include the table name and version" do
        ...
        assert_match(%r{^kasket-#{Kasket::Version::PROTOCOL}/R#{ActiveRecord::VERSION::MAJOR}#{ActiveRecord::VERSION::MINOR}/kasket_test/posts/version=#{POST_VERSION}/}, kasket_query[:key])
      end
